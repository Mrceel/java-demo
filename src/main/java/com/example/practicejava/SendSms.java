...
//        String url = "\thttps://smsapi.cn-north-4.myhuaweicloud.com:443"; //APP接入地址(在控制台"应用管理"页面获取)+接口访问URI
        // 认证用的appKey和appSecret硬编码到代码中或者明文存储都有很大的安全风险，建议在配置文件或者环境变量中密文存放，使用时解密，确保安全；
        String appKey = "x7h0Z91DAGDm391F1kVr7HZ6S9FX"; //APP_Key
        String appSecret = "GGsuuCkUyG9rexFkUwve879oGPr6"; //APP_Secret
        String sender = "csms12345678"; //国内短信签名通道号
        String templateId = "c81a2cb944ff41e590bae8548f06f54f"; //模板ID
        ...
        String receiver = "+86151****6789"; //短信接收人号码
